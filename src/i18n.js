...
const messages = {
  'zh-Hant': {
    ...
    addPlaceAddress: '地址（選填）', addPlaceLocation: '地點（地址或座標）',
  ...
  en: {
    ...
    addPlaceAddress: 'Address (optional)', addPlaceLocation: 'Location (address or coordinates)',
  ...
  ja: {
    ...
    addPlaceAddress: '住所（任意）', addPlaceLocation: '場所（住所または座標）',
