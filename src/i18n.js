...
const messages = {
  'zh-Hant': {
    ...
    adminTitle: '管理員審核', adminSub: '同學新增的地點，通過後就會變成正式資料', adminLoading: '載入中…', adminEmpty: '目前沒有待審核的地點', adminApprove: '通過', adminReject: '刪除', adminRejectConfirm: '確定要刪除這個地點嗎？', adminDone: '已更新', adminDenied: '你沒有管理員權限', profileSave: '儲存', profileSaved: '已儲存', profileShareFail: '已存在此裝置，但無法分享給其他人（連線問題）', profileNeedName: '請填名字',
    ...
    loginPasswordHint: '至少 8 個字，要有數字', loginConfirm: '再輸入一次密碼', errPasswordMismatch: '兩次密碼不一樣', loginSignIn: '登入', loginCreate: '建立帳號',
    ...
    errInvalidInput: '輸入格式不對', errNetwork: '連不上網路', errGeneric: '出了點問題，再試一次', addPlaceDragHint: '輸入地址或精確座標來設定地點',
    addPlaceIcon: '圖示', addPlaceCategory: '分類', addPlaceCuisine: '料理類型', addPlacePayment: '付款方式（可複選）', addPlaceDiet: '飲食', addPlacePrice: '價格範圍（選填）',
    addPlaceSay: '點餐可以這樣說', addPlaceAddress: '地址（選填）', addPlaceLocation: '地點（地址或座標）',
    addPlaceLocationPlaceholder: '完整地址，或 24.9572, 121.2422',
    addPlaceLocationHint: '請輸入完整地址，或「緯度, 經度」。座標會精確設定儲存位置；地址會直接交給 Google 地圖導航。',
    addPlaceNeedLocation: '請輸入地址或座標', addPlaceInvalidCoordinates: '座標超出有效範圍，請檢查緯度和經度',
    ...
    addPlace: '推薦地點', addPlaceName: '地點名稱', addPlaceSearchHint: '打店名就會自動找位置，找不到再自己填座標', addPlaceAlready: '地圖上已經有了 — 點一下去看', addPlaceNearby: '這個位置附近的店，是哪一間？', scoreUnknown: '還沒有人回報', englishAsk: '這裡可以用英文點餐嗎？', englishYes: '可以', englishNo: '不行', englishNone: '還沒有人回報 — 你是第一個', englishTally: '{yes}/{total} 人說可以（{pct}%）', englishThanks: '謝謝回報！', englishAlready: '你已經回報過了', addPlaceFound: '已帶入正確位置 📍', addPlaceNote: '推薦什麼？',
    ...
    'venue.billiards': '撞球 / 斯諾克', 'venue.mall': '購物中心', 'venue.other': '其他',
    'diet.veg': '素食', 'diet.vegan': '全素', cash: '現金',
    'payment.cash': '現金', 'payment.card': '信用卡／金融卡', 'payment.linePay': 'LINE Pay',
    'payment.jkoPay': '街口支付', 'payment.easyCard': '悠遊卡', 'payment.applePay': 'Apple Pay',
  ...
  en: {
    ...
    adminTitle: 'Admin review', adminSub: 'Places added by students become official once approved', adminLoading: 'Loading…', adminEmpty: 'Nothing waiting for review', adminApprove: 'Approve', adminReject: 'Delete', adminRejectConfirm: 'Delete this place?', adminDone: 'Updated', adminDenied: 'You are not an admin', profileSave: 'Save', profileSaved: 'Saved', profileShareFail: 'Saved on this device, but could not be shared with others (connection problem)', profileNeedName: 'Please enter a name',
    ...
    loginPasswordHint: 'At least 8 characters, including a number', loginConfirm: 'Type your password again', errPasswordMismatch: 'The two passwords do not match', loginSignIn: 'Sign in', loginCreate: 'Create account',
    ...
    errInvalidInput: 'Check what you typed', errNetwork: 'Cannot reach the network', errGeneric: 'Something went wrong — try again', addPlaceDragHint: 'Enter an address or exact coordinates to set the location',
    addPlaceIcon: 'Icon', addPlaceCategory: 'Category', addPlaceCuisine: 'Cuisine type', addPlacePayment: 'Payment methods (select all)', addPlaceDiet: 'Diet', addPlacePrice: 'Price range (optional)',
    addPlaceSay: 'Say this to order', addPlaceAddress: 'Address (optional)', addPlaceLocation: 'Location (address or coordinates)',
    addPlaceLocationPlaceholder: 'Full address, or 24.9572, 121.2422',
    addPlaceLocationHint: 'Enter a full address or “latitude, longitude”. Coordinates set the exact saved location; addresses go directly to Google Maps navigation.',
    addPlaceNeedLocation: 'Enter an address or coordinates', addPlaceInvalidCoordinates: 'Those coordinates are out of range—check the latitude and longitude',
    ...
    addPlace: 'Recommend a place', addPlaceName: 'Name', addPlaceSearchHint: 'Type the shop name and we will find it — or enter coordinates yourself', addPlaceAlready: 'Already on the map — tap to see it', addPlaceNearby: 'Shops near this spot — which one?', scoreUnknown: 'No reports yet', englishAsk: 'Was English OK here?', englishYes: 'Yes', englishNo: 'No', englishNone: 'No reports yet — be the first', englishTally: '{yes} of {total} said yes ({pct}%)', englishThanks: 'Thanks for reporting', englishAlready: 'You already reported this one', addPlaceFound: 'Exact location filled in 📍', addPlaceNote: 'What is good here?',
    ...
    'venue.billiards': 'Billiards / snooker', 'venue.mall': 'Shopping mall', 'venue.other': 'Other',
    'diet.veg': 'Vegetarian', 'diet.vegan': 'Vegan', cash: 'Cash',
    'payment.cash': 'Cash', 'payment.card': 'Credit / debit card', 'payment.linePay': 'LINE Pay',
    'payment.jkoPay': 'JKOPay', 'payment.easyCard': 'EasyCard', 'payment.applePay': 'Apple Pay',
  ...
  ja: {
    ...
    adminTitle: '管理者レビュー', adminSub: '学生が追加した場所は承認後に正式データになります', adminLoading: '読み込み中…', adminEmpty: '審査待ちはありません', adminApprove: '承認', adminReject: '削除', adminRejectConfirm: 'この場所を削除しますか？', adminDone: '更新しました', adminDenied: '管理者権限がありません', profileSave: '保存', profileSaved: '保存しました', profileShareFail: 'この端末には保存しましたが、他の人に共有できませんでした（接続の問題）', profileNeedName: '名前を入力してください',
    ...
    loginPasswordHint: '8文字以上、数字を含む', loginConfirm: 'パスワードをもう一度入力', errPasswordMismatch: 'パスワードが一致しません', loginSignIn: 'ログイン', loginCreate: 'アカウント作成',
    ...
    errInvalidInput: '入力内容を確認してください', errNetwork: 'ネットワークに接続できません', errGeneric: '問題が発生しました', addPlaceDragHint: '住所または正確な座標を入力して場所を設定',
    addPlaceIcon: 'アイコン', addPlaceCategory: 'カテゴリー', addPlaceCuisine: '料理の種類', addPlacePayment: '支払い方法（複数選択可）', addPlaceDiet: '食事', addPlacePrice: '価格帯（任意）',
    addPlaceSay: '注文時のひとこと', addPlaceAddress: '住所（任意）', addPlaceLocation: '場所（住所または座標）',
    addPlaceLocationPlaceholder: '住所、または 24.9572, 121.2422',
    addPlaceLocationHint: '住所、または「緯度, 経度」を入力してください。座標は保存場所を正確に設定し、住所は Google マップのナビに直接渡されます。',
    addPlaceNeedLocation: '住所または座標を入力してください', addPlaceInvalidCoordinates: '座標が有効範囲外です。緯度と経度を確認してください',
    ...
    addPlace: '場所を推薦', addPlaceName: '場所の名前', addPlaceSearchHint: '店名を入力すると場所を探します。無ければ座標を入力してください', addPlaceAlready: 'すでに地図にあります — タップで表示', addPlaceNearby: 'この場所の近くの店 — どれですか？', scoreUnknown: 'まだ報告がありません', englishAsk: 'ここは英語で注文できましたか？', englishYes: 'できた', englishNo: 'できなかった', englishNone: 'まだ報告がありません — 最初の一人になりませんか', englishTally: '{total}人中{yes}人ができた（{pct}%）', englishThanks: '報告ありがとう', englishAlready: 'すでに報告済みです', addPlaceFound: '正確な位置を入力しました 📍', addPlaceNote: 'おすすめは？',
    ...
    'venue.billiards': 'ビリヤード / スヌーカー', 'venue.mall': 'ショッピングモール', 'venue.other': 'その他',
    'diet.veg': 'ベジタリアン', 'diet.vegan': 'ヴィーガン', cash: '現金',
    'payment.cash': '現金', 'payment.card': 'クレジット／デビットカード', 'payment.linePay': 'LINE Pay',
    'payment.jkoPay': 'JKOPay', 'payment.easyCard': '悠遊カード', 'payment.applePay': 'Apple Pay',
