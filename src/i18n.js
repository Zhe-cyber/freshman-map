...
const messages = {
  'zh-Hant': {
    ...
    profileSave: '儲存', profileSaved: '已儲存', profileNeedName: '請填名字',
  ...
  en: {
    ...
    profileSave: 'Save', profileSaved: 'Saved', profileNeedName: 'Please enter a name',
  ...
  ja: {
    ...
    profileSave: '保存', profileSaved: '保存しました', profileNeedName: '名前を入力してください',
