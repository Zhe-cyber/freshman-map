...
const messages = {
  'zh-Hant': {
    ...
    cancel: '取消', addPlaceDragHint: '拖曳地圖上的圖釘調整位置',
  ...
  en: {
    ...
    cancel: 'Cancel', addPlaceDragHint: 'Drag the pin on the map to set the spot',
  ...
  ja: {
    ...
    cancel: 'キャンセル', addPlaceDragHint: '地図のピンをドラッグして位置を調整',
