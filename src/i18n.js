...
const messages = {
  'zh-Hant': {
    ...
    addPlaceIcon: '圖示', addPlaceCategory: '分類', addPlaceCuisine: '料理類型', addPlaceDiet: '飲食', addPlacePrice: '價格範圍（選填）',
  ...
  en: {
    ...
    addPlaceIcon: 'Icon', addPlaceCategory: 'Category', addPlaceCuisine: 'Cuisine type', addPlaceDiet: 'Diet', addPlacePrice: 'Price range (optional)',
  ...
  ja: {
    ...
    addPlaceIcon: 'アイコン', addPlaceCategory: 'カテゴリー', addPlaceCuisine: '料理の種類', addPlaceDiet: '食事', addPlacePrice: '価格帯（任意）',
