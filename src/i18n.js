...
const messages = {
  'zh-Hant': {
    ...
    'cuisine.taiwanese': '台灣', 'cuisine.dessert': '甜點', 'cuisine.other': '其他',
  ...
  en: {
    ...
    'cuisine.taiwanese': 'Taiwanese', 'cuisine.dessert': 'Dessert', 'cuisine.other': 'Other',
  ...
  ja: {
    ...
    'cuisine.taiwanese': '台湾料理', 'cuisine.dessert': 'デザート', 'cuisine.other': 'その他',
