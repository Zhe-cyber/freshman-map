...
const messages = {
  'zh-Hant': {
    ...
    addPlaceLocationHint: '請輸入完整地址，或「緯度, 經度」。座標會精確設定圖釘且不能拖曳；地址會直接交給 Google 地圖導航。',
  ...
  en: {
    ...
    addPlaceLocationHint: 'Enter a full address or “latitude, longitude”. Coordinates set a precise, non-draggable pin; addresses go directly to Google Maps navigation.',
  ...
  ja: {
    ...
    addPlaceLocationHint: '住所、または「緯度, 経度」を入力してください。座標は移動できない正確なピンを設定し、住所は Google マップのナビに直接渡されます。',
