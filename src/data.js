...
export const MOCK = {
  ...
  items: [
    ...
    I('elec-b1tf','elec','B1','toilet','TODO landmark','女 women', null, 'elec-b1tf.jpg'),
    I('elec-b1tm','elec','B1','toilet','TODO landmark','男 men', null, 'elec-b1tm.jpg'),
    I('elec-b1w','elec','B1','water','TODO landmark','飲水機 water dispenser', null, 'elec-b1w.jpg'),
    I('elec-1ftf','elec','1F','toilet','TODO landmark','女 women', null, 'elec-1ftf.jpg'),
    I('elec-1ftm','elec','1F','toilet','TODO landmark','男 men', null, 'elec-1ftm.jpg'),
    I('elec-1fw','elec','1F','water','TODO landmark','飲水機 water dispenser', null, 'elec-1fw.jpg'),
    I('elec-2ftf','elec','2F','toilet','TODO landmark','女 women', null, 'elec-2ftf.jpg'),
    I('elec-2ftm','elec','2F','toilet','TODO landmark','男 men', null, 'elec-2ftm.jpg'),
    I('elec-2fw','elec','2F','water','TODO landmark','飲水機 water dispenser', null, 'elec-2fw.jpg'),
    I('elec-3ftf','elec','3F','toilet','TODO landmark','女 women', null, 'elec-3ftf.jpg'),
    I('elec-3ftm','elec','3F','toilet','TODO landmark','男 men', null, 'elec-3ftm.jpg'),
    I('elec-3fw','elec','3F','water','TODO landmark','飲水機 water dispenser', null, 'elec-3fw.jpg'),
    I('elec-4ftf','elec','4F','toilet','TODO landmark','女 women', null, 'elec-4ftf.jpg'),
    I('elec-4ftm','elec','4F','toilet','TODO landmark','男 men', null, 'elec-4ftm.jpg'),
    I('elec-4fw','elec','4F','water','TODO landmark','飲水機 water dispenser', null, 'elec-4fw.jpg'),
    I('elec-5ftm','elec','5F','toilet','TODO landmark','男 men', null, 'elec-5ftm.jpg'),
    I('elec-5fw','elec','5F','water','TODO landmark','飲水機 water dispenser', null, 'elec-5fw.jpg'),
    I('elec-6ftm','elec','6F','toilet','TODO landmark','男 men', null, 'elec-6ftm.jpg'),
    I('elec-6fw','elec','6F','water','TODO landmark','飲水機 water dispenser', null, 'elec-6fw.jpg'),
    I('elec-7ftf','elec','7F','toilet','TODO landmark','女 women', null, 'elec-7ftf.jpg'),
    I('elec-7fw','elec','7F','water','TODO landmark','飲水機 water dispenser', null, 'elec-7fw.jpg'),
    I('elec-8ftm','elec','8F','toilet','TODO landmark','男 men', null, 'elec-8ftm.jpg'),
    I('elec-8fw','elec','8F','water','TODO landmark','飲水機 water dispenser', null, 'elec-8fw.jpg'),
    I('duxin-1ftf','duxin','1F','toilet','TODO landmark','女 women', null, 'duxin-1ftf.jpg'),
    I('duxin-1ftm','duxin','1F','toilet','TODO landmark','男 men', null, 'duxin-1ftm.jpg'),
    I('duxin-1fw','duxin','1F','water','TODO landmark','飲水機 water dispenser', null, 'duxin-1fw.jpg'),
    I('duxin-2ftm','duxin','2F','toilet','TODO landmark','男 men', null, 'duxin-2ftm.jpg'),
    I('duxin-2fw','duxin','2F','water','TODO landmark','飲水機 water dispenser', null, 'duxin-2fw.jpg'),
    I('duxin-3ftf','duxin','3F','toilet','TODO landmark','女 women', null, 'duxin-3ftf.jpg'),
    I('duxin-3fw','duxin','3F','water','TODO landmark','飲水機 water dispenser', null, 'duxin-3fw.jpg'),
    I('duxin-4ftm','duxin','4F','toilet','TODO landmark','男 men', null, 'duxin-4ftm.jpg'),
    I('duxin-4fw','duxin','4F','water','TODO landmark','飲水機 water dispenser', null, 'duxin-4fw.jpg')
  ],
